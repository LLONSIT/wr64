...
u32 D_801D9B30[0x400]; // stack bottom
...
#endif
        osCreateThread(&piMgrThread, 0, __osDevMgrMain, (void *) &__osPiDevMgr, &D_801D9B30[0x400], pri);
...
*/
#pragma GLOBAL_ASM("asm/nonmatchings/os/osCreatePiManager/osCreatePiManager.s")
